...
To read it from the Google Sheet automatically into R, you'll need the `googlesheets` package.  Install it, and then run the following code:


```{r}
library(googlesheets)

key <- extract_key_from_url("https://docs.google.com/spreadsheets/d/143-u41MokWNU6w4_hptUypQ_sIc4ZIfEDsABq4MzDhA/edit?usp=sharing")
my_ss <- gs_key(key, visibility = "public")
bike_data <- gs_read(my_ss)
