...
Arrange these three graphs into a 3x1 grid (3 rows, 1 column).  Be sure to specify appropriate `fig.width` and `fig.height` options in your R Markdown code chunk so that the graphs look good in the output.
