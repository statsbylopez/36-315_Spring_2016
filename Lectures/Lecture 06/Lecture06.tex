...
\begin{frame}\frametitle{Contingency Tables}
	...
	\textbf{Asympototics}:  %Can get some additional (statistical) information:
...
\begin{frame}\frametitle{Recall:  Independence Rules from Probability}
	...
	E.g. {\verb+chisq.test(table(var1, var2))}
...
\begin{frame}\frametitle{Mosaic Plots}
	...
	\textbf{Wednesday}:  Mosaic Plot Demo%Several conditional distributions\\
