...
\begin{frame}\frametitle{Box Plots vs. Histograms)}
	\includegraphics[width=\linewidth]{bp-vs-hist.png}
\end{frame}
...
\begin{frame}\frametitle{Offsides in Soccer (@DannyPage)}
	\includegraphics[width=\linewidth]{mls.jpg}
\end{frame}
