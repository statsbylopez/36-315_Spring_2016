...
\begin{frame}\frametitle{Via 538:  Chances of Winning Iowa Republican Caucuses}
	\includegraphics[width=\linewidth]{iowa.png}
\end{frame}



\begin{frame}\frametitle{Via 538:  Chances of Winning in New Hampshire (Democrats)}
	\centering
	\includegraphics[width=0.66\linewidth]{nh.png}
\end{frame}
